...
export function ResourceQnAPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        '제품 설치 방법은 제품별로 다릅니다. 각 제품의 설치 매뉴얼을 참고하시거나, 시뮬레이터에서 배치 방법을 확인하실 수 있습니다. 전문 설치가 필요하시면 구매 컨설팅을 통해 안내받으실 수 있습니다.',
      date: '2026-02-25',
    },
    {
      id: 6,
      ...
      answer:
        '제품별 보증 기간이 다릅니다. 일반적으로 1년에서 2년의 보증 기간이 제공됩니다. 정확한 보증 기간은 구매 시 제공되는 보증서를 확인해주세요.',
      date: '2026-02-20',
    },
  ];
          ...
          <div className="mb-8 flex items-center gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none w-full bg-white border border-border rounded-lg py-3 pl-4 pr-10 text-left focus:outline-none focus:ring-2 focus:ring-primary"
              >
